...
class PathsConfig(BaseModel):
    ...
    input_dir: Path = Field(default=Path("./data/export"), validation_alias="ML_INPUT_DIR")
    artifact_dir: Path = Field(default=Path("./artifacts"), validation_alias="ML_ARTIFACT_DIR")
