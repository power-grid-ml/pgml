...
pandapower into a pgml :class:`~pgml.schemas.grid_schema.Grid`.  They are used by
the oracle comparison tests and example scripts to supply a consistent, reproducible
input grid.
